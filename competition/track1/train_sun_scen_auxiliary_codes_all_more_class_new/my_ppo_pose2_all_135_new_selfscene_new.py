...
if __name__ == "__main__":
    ...
    # 环境参数设置
    ###################################
    # 场景列表 "1_to_3lane_right_turn_c"  1
    scenarios = ["1_to_3lane_left_turn_c", "1_to_3lane_left_turn_t", "lanes_merge_single_agent", \
                 "lanes_cruise_single_agent", "lanes_overtake", "lanes_cut_in"]
    scenario_nums = [2, 1, 3, 3, 3, 2]
    # 是否使用sumo的可视化
