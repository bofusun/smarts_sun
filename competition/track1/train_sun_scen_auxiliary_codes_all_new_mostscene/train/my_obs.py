...
class FilterObs(gym.ObservationWrapper):
    ...
    def observation(self, obs: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
        ...
        for agent_id, agent_obs in obs.items():
            ...
            elif self.scenario == "1_to_3lane_left_turn_c_1":
                scenario_obs = np.array([1])
            elif self.scenario == "1_to_3lane_left_turn_t":
                scenario_obs = np.array([2])
            elif self.scenario == "lanes_merge_single_agent_1":
                scenario_obs = np.array([3])
            elif self.scenario == "lanes_merge_single_agent_2":
                scenario_obs = np.array([4])
            elif self.scenario == "lanes_merge_single_agent_3":
                scenario_obs = np.array([5])
            elif self.scenario == "lanes_cruise_single_agent_1":
                scenario_obs = np.array([6])
            elif self.scenario == "lanes_cruise_single_agent_2":
                scenario_obs = np.array([7])
            elif self.scenario == "lanes_cruise_single_agent_3":
                scenario_obs = np.array([8])
            elif self.scenario == "lanes_overtake_1":
                scenario_obs = np.array([9])
            elif self.scenario == "lanes_overtake_2":
                scenario_obs = np.array([10])
            elif self.scenario == "lanes_overtake_3":
                scenario_obs = np.array([11])
            elif self.scenario == "lanes_cut_in_1":
                scenario_obs = np.array([12])
            elif self.scenario == "lanes_cut_in_2":
