...
class PPO():
    ...
    def eval_episodes(self):
        ...
        self.logger.info('steps={}\t test_return_reward={:.5f}'.format(self.counter, np.mean(return_rewards)))
    ...
    def run_steps(self):
        ...
        if self.load_counter:
            ...
            kls = data['resource_kl']
            lrs = data['resource_lr']
        else:
            test_return_rewards = []
        ...
        while self.counter < self.max_steps:
            ...
            if self.counter % self.eval_interval == 0:
                test_return_reward = self.eval_episodes()
                test_return_rewards.append(test_return_reward)
            if self.counter % self.log_interval == 0:
                save_info = {"train_return_rewards": train_return_rewards, "test_return_rewards": test_return_rewards,\
